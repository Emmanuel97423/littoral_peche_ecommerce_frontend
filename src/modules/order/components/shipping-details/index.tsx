...
const ShippingDetails = ({
  ...
  return (
    <div className="text-base-regular">
      <h2 className="text-base-semi">Expédition</h2>
      <div className="my-2">
        <h3 className="text-small-regular text-gray-700">Addresse</h3>
      ...
      <div className="my-2">
        <h3 className="text-small-regular text-gray-700">Méthode d&apos;expédition</h3>
        <div>
