  ...
  return (
    <div className="bg-amber-100 px-8 py-24 flex flex-col justify-center items-center text-center">
      ...
      <p className="text-base-regular mt-4 mb-6 max-w-[32rem]">
        Vous n&apos;avez rien dans votre panier. Changeons cela, utilisons
        le lien ci-dessous pour commencer à parcourir nos articles.
      </p>
      <div>
        <UnderlineLink href="/store">Explorer plus d&apos;articles</UnderlineLink>
      </div>
    </div>
  )
}
