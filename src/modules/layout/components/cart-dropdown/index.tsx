    ...
    <div className="h-full z-50" onMouseEnter={open} onMouseLeave={close}>
      <Popover className="relative h-full">
        <Link href="/cart" passHref>
          <Popover.Button className="h-full">{`Panier (${totalItems})`}</Popover.Button>
        </Link>
        <Transition
          show={state}
          as={Fragment}
        ...
        >
          ...
          >
            <div className="p-4 flex items-center justify-center">
              <h3 className="text-large-semi">MON PANIER</h3>
            </div>
            {cart && items?.length ? (
              <>
                ...
                <div className="p-4 flex flex-col gap-y-4 text-small-regular">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-700 font-semibold">
                      Sous-total{" "}
                      <span className="font-normal">(taxes incl.)</span>
                    </span>
                  ...
                  <div>
                    <Link href="/store">
                      <a>
                        ...
                        <Button onClick={close}>Explorer d&apos;autres articles</Button>
                      </a>
                    </Link>
                  </div>
                </div>
